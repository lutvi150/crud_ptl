            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">Reservasi Hotel</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-1">Welcome Selamat Datang di {{ env('APP_NAME') }}! 👋</h4>
              <p class="mb-6">Silah login Menggunakan username dan password yang telah diberikan</p>
              ...
              <p class="text-center">
                <span>Belum punya akun di {{ env('APP_NAME') }}?</span>
